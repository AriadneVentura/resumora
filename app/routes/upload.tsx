...
const Upload = () => {
    ...
    // Handles analysis of resumes that are uploaded when matched against data.
    const handleAnalyse = async ( { companyName, jobTitle, jobDescription, file }: {
        ...
        // Uplaod the image to puter's storage.
        ...
        <main className="bg-[url('/images/bg-main.svg')] bg-cover">
            ...
            <section className="main-section">
                <div className="page-heading py-16">
                    <h1>Smart feedback for new beginnings</h1>
                    { isProcessing ?
                        (
                            <>
                                <h2>{ statusText }</h2>
                        ...
                        (
                            <h2>Upload your resume to illuminate your ATS score and awaken its potential</h2>
                        )
                    }
